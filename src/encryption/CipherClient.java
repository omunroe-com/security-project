...
public class CipherClient
{
        public static void main(String[] args) throws Exception 
        {
            ...
            key_chain = my_gen.generateKey();  //key is now generated

            // This will create a new ObjectOutputStream and specify the text file
            ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream("OutKeyDES.txt"));
            ...
            // This will encrypt the message above using the key and send it over socket s to the server.
